  ...
  return (
    <main className="py-20">
      <div className="container mx-auto px-4 max-w-4xl">
        <h1 className="text-5xl font-bold text-primary-700 mb-8">About Business 9ca9b9ac-39d1-462f-9f16-9c62e308a1ff</h1>

        <div className="prose prose-lg">
          <p className="text-xl text-gray-700 mb-6">
            With over two decades of experience in business-9ca9b9ac-39d1-462f-9f16-9c62e308a1ff, we've built our reputation on
          ...
          <p className="text-gray-700">
            To provide our clients with trusted, reliable business-9ca9b9ac-39d1-462f-9f16-9c62e308a1ff services that exceed expectations
          ...
          <div className="bg-primary-50 p-8 rounded-lg mt-12">
            ...
            <p className="text-gray-700">
              Ready to work with a trusted business-9ca9b9ac-39d1-462f-9f16-9c62e308a1ff partner? Contact us today to discuss your needs.
            </p>
